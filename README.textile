...
Everything should be downloaded and unpacked under the Release folder, then a quick patch should be applied to ir.exe.config for signing issues (may not be necessary in the future).
